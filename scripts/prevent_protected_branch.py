...
def main() -> int:
    ...
    if branch in PROTECTED_BRANCHES:
        print(
            f"Refusing to commit on protected branch '{branch}'. Create a feature branch first."
        )
        return 1
    ...
    if blocked_pushes:
        ...
        print(
            f"Refusing to push directly to protected branch: {branches}. Open a PR instead."
        )
        return 1
